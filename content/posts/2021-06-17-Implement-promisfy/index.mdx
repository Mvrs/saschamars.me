...
A `Promise` is a special JavaScript object that links these statees together.
...
On a serious note, it's a promise to return something eventually. MDN has many examples on how you can [chain things together](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises) and don't have to be explicit.
