...
Since the adoption of `Hooks` develpers found a new way of sharing logic across multiple siblings. With a less cumbersome approach than the typical **Class** pattern the behavior of passing down props are less convoluted. Hooks which are functions
